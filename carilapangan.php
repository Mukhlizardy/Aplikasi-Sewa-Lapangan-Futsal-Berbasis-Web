...
<body>
  <div style="position: relative; min-height: 100%">
    ...
    <div class="content">
      <h1>COURT LIST</h1>
      <hr>
      <form method="POST" action="carikendaraan.php">
      ...
      <?php
        include 'koneksi.php';
        $no=1;
        $sql = mysqli_query($koneksi, "select * from datak where line_nomor = '$cari' || merk = '$cari' || tipe = '$cari' || warna = '$cari' || status = '$cari'") or die (mysqli_error());
